...
public class Operators {
    public static void main(String[] args) {
        ...
        /* Assignment works with variable values as well as literal values. 
        ...
        // You can chain addition operators together: result now equals 20
        result = 1 + operand1 + operand2 + operand3;

        /* Finally, the += operator is used to add a value to a 
        variable. result += operand1 is equivalent to result = result + operand1. 
        ...
        // Subtraction is a binary infix operator.  It works with literals:
        ...
        // You can chain subtraction operators together: result now equals 0
        result = 19 - operand1 - operand2 - operand3;

        /* Finally, the -= operator is used to add a value to a variable. result
        -= operand1 is equivalent to result = result - operand1.
        ...
        // Multiplication is a binary infix operator.  It works with literals:
        ...
        // You can chain multiplication operators together: result now equals 490
        ...
        *= operand1 is equivalent to result = result * operand1.
        ...
        /*What?!?!?!?!  When dividing integers, integer division is used - we 
        only get the whole number part of the quotient.  In this case, 
        ...
        // You can chain division operators together: result now equals 1
        result = 245 / operand1 / operand2 / operand3;

        /* Finally, the /= operator is used to add a value to a variable. 
        result /= operand1 is equivalent to 
